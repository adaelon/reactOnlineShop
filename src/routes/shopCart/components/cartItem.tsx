            ...
            <div>
              <Row className="flex-box">
                <Col span={5} className="flex-box">
                  <img className="good-img" src={cartItem.productImage} alt="" />
                </Col>
                <Col span={19} className="flex-box flex-ver-box flex-al-st">
                  <p>{cartItem.productName}</p>
                  <p>
                    售价:{cartItem.productPrice}元 合计：
                    {cartItem.productPrice * cartItem.number}元
                  </p>
                  <div className="flex-box ">
                    <div
                      className="desc t-tc"
                      onClick={() =>
                        this.changeNum(cartItem.number, cartItem.productId, -1)
                      }>
                      -
                    </div>
          ...
          <Col span={4}>
            <div className="flex-box">
              <Iconfont
                ...
                {...common}
                style={{ ...iconStyle }}
                onClick={() => this.removeThisGood(cartItem.productId)}
              />
            </div>
          </Col>
        </Row>
